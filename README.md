...
![](./report_figures/results/output_AP_LC.png) | ![](./report_figures/results/output_AP_UC.png) | ![](./report_figures/results/output_AP_black_center.png)
-----------------------------------------------|--------------------------------------------------
 | ![](./report_figures/results/output_AP_bw_ratio.png) | ![](./report_figures/results/output_AP_bw_ratio_UC_to_LC.png) | ![](./report_figures/results/output_AP_transitions.png)
